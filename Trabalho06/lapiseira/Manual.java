...
public class Manual {
    public static void main(String[] args) {
        System.out.println("-- case inserindo grafites --");
        ...
        System.out.println("-- case inserindo e removendo --");
        ...
        System.out.println("-- case escrevendo 1 --");
        //case escrevendo 1
        ...
        System.out.println("-- case escrevendo 2 --");
        //case escrevendo 2
        lapiseira = new Lapiseira(0.9f);
