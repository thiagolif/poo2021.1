...
public class Manual {
    public static void main(String[] args) {
        ...
        System.out.println("-- case comer --");
        //case comer
        pet.eat();
        System.out.print(pet);
        //E:15/20, S:10/10, L:7/15, D:2, I:3

        System.out.println("-- case dormir --");
        //case dormir
        pet.sleep();
        System.out.print(pet);
        //E:20/20, S:9/10, L:7/15, D:2, I:4

        System.out.println("-- case shower --");
        //case tomar banho
        pet.shower();
        System.out.print(pet);
        //E:17/20, S:8/10, L:15/15, D:2, I:6

        System.out.println("-- case dormir sem sono --");
        //case dormir sem sono
        pet.sleep();
        //fail: nao esta com sono

        System.out.println("-- case morrer --");
        //case morrer
        pet.play();
        pet.play();
        pet.play();
        ...
        System.out.println("-- case exemplo2 --");
        //case exemplo2
        pet = new Pet(5, 10, 10);
        pet.play();
        pet.play();
        ...
        System.out.println("-- case exemplo3 --");
        //case exemplo3
        pet = new Pet(10, 3, 10);
        pet.play();
        pet.play();
